if IY_LOADED and not _G.IY_DEBUG then
	-- error("Minz42 Admin is already running!", 0)
	return
end
...
local iyassets = {
	...
	["infiniteyield/assets/logo.png"] = "rbxassetid://89985947950414",
...
Title.TextSize = 18
Title.Text = "Minz42 Admin v" .. currentVersion
...
PluginsHint.Text = "Download plugins from the VSS Discord (https://discord.gg/MrB928wXfN)"
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			toClipboard("https://discord.gg/MrB928wXfN")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/MrB928wXfN)"
	end)
	dragGUI(main)
	main.Parent = ScaledHolder
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- 	Minz42 Admin Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Minz42 Admin discord server.'}
...
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = 'Opens DEX by Visnouk'}
CMDs[#CMDs + 1] = {NAME = 'olddex / odex', DESC = 'Opens Old DEX by Visnouk'}
CMDs[#CMDs + 1] = {NAME = 'remotespy / rspy', DESC = 'Opens Simple Spy V3'}
CMDs[#CMDs + 1] = {NAME = 'executor', DESC = 'Opens an internal executor gui by Visnouk'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/chamnannoreakviznouk/Minz42Admin/refs/heads/main/admin.lua")
	end
end)
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		toClipboard('https://discord.gg/MrB928wXfN')
		notify('Discord Invite', 'Copied to clipboard!\nhttps://discord.gg/MrB928wXfN')
	else
		notify('Discord Invite', 'https://discord.gg/MrB928wXfN')
	end
	if httprequest then
		httprequest({
...
addcmd('keepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = true
		notify('KeepIY','Minz42 Admin will now run after you teleport')
		updatesaves()
	else
...
addcmd('unkeepiy', {}, function(args, speaker)
	if queueteleport then
		KeepInfYield = false
		notify('KeepIY','Minz42 Admin will no longer run after you teleport')
		updatesaves()
	else
		notify('Incompatible Exploit','Your exploit does not support this command (missing queue_on_teleport)')
	end
...
addcmd("f3x", {"fex"}, function(args, speaker)
	loadstring(game:HttpGet("https://raw.githubusercontent.com/chamnannoreakviznouk/Minz42Admin/refs/heads/main/FEX"))()
end)
